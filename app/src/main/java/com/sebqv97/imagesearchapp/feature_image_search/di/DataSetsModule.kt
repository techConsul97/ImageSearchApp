...
import com.sebqv97.imagesearchapp.feature_image_search.data.local.entity.ImagesDatabase
...
object DataSetsModule {
    @Singleton
    @Provides
    fun provideSchoolApi(retrofit: Retrofit): ImagesApi = retrofit.create(ImagesApi::class.java)
